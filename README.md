...
-  _hyPIRana_: analysis of PiFM hyperspectral data (providing callibration, mean spectra, PCA); _AreaSelect_ allows to choose a spacial region of interest via a gui
