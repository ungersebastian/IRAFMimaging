...
#                         Project Name : IPHT                                                   = #
#                                                                                               = #
#                   File Name : drawSlopePointsOnToPo.py                                        = #
#                                                                                               = #
#                          Programmer : Luo Meng                                                = #
#                                                                                               = #
...
class SlopeFigure:
    ...
    def readData(self):
        # read data from txt file 
        with open("C:/Users/15025/Desktop/IPHT/data/image3Pixel.txt", "r") as f:
    ...
    def drawFigures(self):
        ...
        for value in self.list1:
            scatter1 = plt.scatter(value[0], value[1], marker="o", color='red')
            
        for value in self.list2:
            scatter2 = plt.scatter(value[0], value[1], marker="^", color='blue')
